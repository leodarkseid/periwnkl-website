            ...
            <div className={styles.dash_grid}>
                ...
                <div className={styles.emp_others}>
                    <div className={styles.emp_slab1}>
                        <div className="bg-36b9cc w-75 p-3 text-white  rounded-end-pill mb-3"> <BsBank style={{ "transform": "scale(1.5)", "marginRight": "10px" }} /> Contract Balance : {date == "" ? <Placehold size={3} /> : date} </div>
                        ...
                        <div className="bg-primary w-75 p-3 text-white  rounded-end-pill mb-3"><LiaSuitcaseSolid style={{ "transform": "scale(1.5)", "marginRight": "10px" }} />Wage Bill : {grossExcercised == Infinity ? <Placehold size={1} /> : grossExcercised}</div>
                        <div className="bg-ff6f61 w-75 p-3 text-white  rounded-end-pill mb-3"><BsBank style={{ "transform": "scale(1.5)", "marginRight": "10px" }} />Total Balance : {grossVested == Infinity ? <Placehold size={2} /> : grossVested} </div>
